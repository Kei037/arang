          ...
          <div class="detail_wrapper d-flex">
            <div class="side_block">
              <div class="artist_info">
                ...
                <div class="artist_avatar">
                  <img src="/fake_resources/img/윤라희/윤라희.jpg" alt="윤라희jpg">
                </div>
              </div>
            </div>
            <div class="content_block">
              <div class="review">
                ...
                <p><br></p>
                <p>
                  <img src="/fake_resources/img/윤라희/artist_focus_main.jpg" alt="artist_main">
                </p>
              </div>
              <div class="product">
                <h4 class="sub_title">ArtWork</h4>
                <div id="product2" class="item_list1">
                  <div class="slick_list">
                    <div class="slick_trak artworks">
                      <div class="item">
                          <div class="artwork_wrap">
                            <a href="../../html_artwork/artwork_focus.html"><img class="artwork" src="/fake_resources/img/윤라희/윤라희-오브제1_s02.jpg" alt="오브제1" onload="JavaScript:artwork_middle(this)"></a>
                          </div>
                        <figcaption>
                      ...
                      <div class="item">
                          <div class="artwork_wrap">
                            <a href="#"><img class="artwork" src="/fake_resources/img/윤라희/윤라희-오브제2_s01_fub8Yrj.jpg" alt="오브제2" onload="JavaScript:artwork_middle(this)"></a>
                          </div>
                        <figcaption>
                          <h5>BLOCK (Falling Bluse Brown)</h5>
                          <p>Limited Unique</p>
                      ...
                      <div class="item">
                          <div class="artwork_wrap">
                            <a href="#"><img class="artwork" src="/fake_resources/img/윤라희/윤라희-오브제3_s01_gpLUosS.jpg" alt="오브제3" onload="JavaScript:artwork_middle(this)"></a>
                          </div>
                        <figcaption>
                          <h5>BLOCK (Falling Bluse Brown)</h5>
                          <p>Limited Unique</p>
              ...
              <div class="btn_group2">
                <a href="./artist_upload.html"><button class="btn2 modify">페이지 등록</button></a>
                <a href="./artist_modify.html"><button class="btn2 modify">페이지 수정</button></a>
                <a href="./artwork_upload.html"><button class="btn2 modify">작품 등록</button></a>
              </div>
            </div>
            <div class="side_block">
              <!-- <div class="btn_group2">
